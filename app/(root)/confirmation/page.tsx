...
export default function ConfirmationPage() {
  return (
    <div className="relative flex items-center justify-around flex-col w-full h-full overflow-hidden">
      <div className="flex flex-col items-center justify-center relative">
        <div className="flex items-center justify-center relative flex-grow h-full">
          ...
          <div className="absolute z-50 bg-white/50 backdrop-blur-lg w-fit h-full mb-8 p-6 rounded-3xl flex flex-col items-center space-y-4 sm:space-y-0 sm:flex-row overflow-hidden">
