      ...
      >
        ...
        >
          <Input
            ...
            className={cn(
              "w-full rounded-full py-5 shadow-xl mt-2 pl-6",
        ...
        <Input
          className={cn(
            "rounded-full shadow-xl py-5 w-full pl-6",
            form.formState.errors.ecName && "border-red-500"
          )}
          placeholder="EC Name"
          onKeyDown={(e) => handleKeyDown(e, roleRef)}
          {...form.register("ecName", {
            required: true,
            onChange: () => form.trigger("ecName"),
          })}
        />
