...
export default function Dashboard() {
  return (
    <div className="fixed top-10 flex items-center p-2 w-full max-w-7xl rounded-3xl">
      <div className="flex flex-col mx-6">
        <div className="bg-white/20 backdrop-blur-lg shadow-md text-black h-full mx-auto relative w-[70vw] py-4 rounded-3xl flex items-center">
        ...
        <div className="bg-white/40 rounded-3xl flex items-center mt-4 ml-4 p-2">
          <MemberCards
            members={10}
            text="Enrolment"
            icon={
