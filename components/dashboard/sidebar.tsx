        ...
        <div className="bg-white/30 rounded-lg p-3 h-full">
          <div className="bg-white/60 shadow-xl rounded-lg h-full w-[280px] flex flex-col">
            ...
            <div className="flex flex-col h-full p-4">
              ...
              {name ? (
                <div className="text-center text-md sm:text-xl font-inter">
                  {name}
                </div>
              ) : (
              ...
              <div className="flex flex-col flex-1 mt-8 space-y-4 font-mulish overflow-y-auto">
                ...
                <div className="space-y-4 px-2">
                  <div className="text-lg font-light text-slate-500">Menu</div>

                  <div className="space-y-2">
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button className="flex items-center text-slate-400 w-full hover:bg-white/50 p-2 rounded-lg transition-colors">
                      ...
                      <TooltipContent side="right">
                        <ToolTipMessage>
                          ...
                          ipsumelorem ipsumelorem ipsumelorem ipsumelorem
                          ipsumelorem ipsumelorem ipsumelorem ipsume
                        </ToolTipMessage>
                      </TooltipContent>
                    </Tooltip>
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button className="flex items-center text-slate-400 w-full hover:bg-white/50 p-2 rounded-lg transition-colors">
                          ...
                          <span className="ml-3 font-light">Members</span>
                        </button>
                      </TooltipTrigger>
                      <TooltipContent side="right">
                        <ToolTipMessage>
                  ...
                  <div className="space-y-2 pt-4">
                    ...
                    <button className="flex items-center text-slate-400 w-full hover:bg-white/50 p-2 rounded-lg transition-colors">
                      ...
                      <span className="ml-3 font-light">Profile</span>
                    </button>

                    <button className="flex items-center text-slate-400 w-full hover:bg-white/50 p-2 rounded-lg transition-colors">
                      <Image alt="" src={faq} width={20} height={20} />
                      <span className="ml-3 font-light">FAQ&apos;s</span>
                    </button>
                  </div>
                </div>
              </div>
