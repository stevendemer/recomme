...
export default function ChatBubble({
  ...
  return (
    <div className="relative sm:max-w-3xl w-full p-2 sm:p-4 bg-white text-black rounded-3xl tracking-wider shadow-inner from-gray-100 to-gray-400 drop-shadow-lg">
      <div className="absolute left-0 top-1/2 transform -translate-y-1/2 sm:-translate-x-full">
